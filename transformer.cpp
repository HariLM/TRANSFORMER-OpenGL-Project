...
float sx = 1, sy = 1, sz = 1, fsx = 1, fsy = 1, fsz = 1, tx = 0, ty = 200, tz = 0;
int tpos = 640, ftx = 0, fty = 0, ftz = 0, rxa = 0, rya = 0, flag = 0, vflag = 0, fflag = 0, vtx = 520, allover = 0, i = 0, moveSpeed = 5;
bool day = true;
int starPositions[24][2] = {
	{50, 530}, {30, 500}, {200, 530}, {150, 430}, {250, 500}, {200, 410}, {600, 410}, {700, 350}, {800, 470}, {550, 300}, {1150, 530}, {1170, 500}, {1000, 530}, {1050, 430}, {950, 500}, {1000, 410}, {30, 250}, {5, 310}, {45, 300}, {30, 330}, {1170, 250}, {1195, 310}, {1155, 300}, {1170, 330}

};

GLfloat bodyColor[3] = {0.2, 0.2, 0.7};
...
void nightBackground()
{
	...
	ellipse.draw(200, 530, 55, 30, 1, false, 0, 360);
	for (int s = 0; s < 24; s++)
	{
		ellipse.draw(starPositions[s][0], starPositions[s][1], 6, 2, 1, false, 0, 360);
	}
}
void robot()
{
...
void displayIntro(void)
{
	...
	glVertex3f(0, 640, 10);
	glTexCoord2f(0, 1);
	glVertex3f(1200, 640, 10);
	glTexCoord2f(1, 1);
	glVertex3f(1200, 0, 10);
	glTexCoord2f(1, 0);
	glEnd();
	glFlush();
...
void display()
{
	...
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	day ? background() : nightBackground();
	glBegin(GL_QUADS);
	glColor3f(0.4, 0.4, 0.4);
	glVertex3i(-1200, 120, 10);
	glVertex3i(2480, 120, 10);
	glVertex3i(2480, 160, 10);
	glVertex3i(-1200, 160, 10);
	glEnd();
...
{
	int menu;
	int submenu_id = glutCreateMenu(processSubmenu);
	...
	glutAddMenuEntry("Increase Car speed", 3);
	glutAddMenuEntry("Decrease Car speed", 4);
